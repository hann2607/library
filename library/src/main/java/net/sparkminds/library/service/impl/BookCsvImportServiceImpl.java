...
@Log4j2
public class BookCsvImportServiceImpl implements BookCsvImportService{
	...
	private boolean validateFile(MultipartFile fileCSV) {
		String message = null;
		String contentType = null;
		
		// Check size > 5MB
		if (fileCSV.getSize() > 5 * 1024 * 1024) { 
		...
		// Only accept CSV        
		contentType = fileCSV.getContentType();
